...
function affContenuL(?array $errs) : void {
    ...
    affLigneInput('Votre numéro de téléphone :', array('type' => 'tel', 'name' => 'telephone', 'value' => $values['telephone'],
                  'placeholder'=>'Format : 03.81.66.64.52', 'pattern'=>'^(\d{2}\.){4}\d{2}$', 'required' => null));
    affLigneInput('Votre date de naissance :', array('type' => 'date', 'name' => 'naissance', 'value' => $values['naissance'], 'required' => null));
    affLigneInput('Choisissez un mot de passe :', array('type' => 'password', 'name' => 'pass1', 'value' => '',
                  'placeholder' => LMIN_PASSWORD . ' caractères minimum', 'required' => null));
    affLigneInput('Répétez le mot de passe :', array('type' => 'password', 'name' => 'pass2', 'value' => '', 'required' => null));
    echo
                '</table>',
            '</section>',
            '<section>',
